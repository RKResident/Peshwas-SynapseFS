...
**3.2 Re-basing interval N (delta-chain depth).**
Committing epoch 50 against epoch 49 means walking 49 residuals to reconstruct
the base. Needs either periodic full baselines or a bounded chain depth.
*Why it matters:* directly sets `commit` and `checkout` wall-clock, both graded.
*Settles:* FORMAT.md §13.
