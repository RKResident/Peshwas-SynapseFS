...
int main(int argc, char** argv) {
    ...
    if(std::string(argv[1]) == "serve") {
        ...
        // `push` and `pull` return 0 on success, like the rest of this file.
        // Negating them inverted the exit code: a completed transfer reported
        // failure and a failed one reported success, so any script that
        // checked `$?` did the opposite of the right thing.
